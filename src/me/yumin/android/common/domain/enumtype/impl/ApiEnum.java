...
public enum ApiEnum implements IEnvEnum {
	...
	TOP_AUTO_LOGIN_V2(
		...
		"http://api.waptest.taobao.com/rest/api3.do?api=com.taobao.client.sys.autoLogin&v=v2"
	),
	// 获取令牌
	TOP_GET_APP_TOKEN(
		"http://api.m.taobao.com/rest/api2.do?api=com.taobao.client.sys.getAppToken&v=*",
		"http://api.waptest.taobao.com/rest/api3.do?api=com.taobao.client.sys.getAppToken&v=*"
	),
	// 登录淘宝
	TOP_LOGIN_V2(
		"http://api.m.taobao.com/rest/api2.do?api=com.taobao.client.sys.login&v=v2", 
		"http://api.waptest.taobao.com/rest/api3.do?api=com.taobao.client.sys.login&v=v2"
	),
	// 核销校验
	TOP_BEFORE_CONSUME(
		"http://api.m.taobao.com/rest/api2.do?api=mtop.eticket.wirelessbeforeconsume&v=1.0", 
		"http://api.waptest.taobao.com/rest/api3.do?api=mtop.eticket.wirelessbeforeconsume&v=1.0"
	),
	// 执行核销
	TOP_CONSUME(
		"http://api.m.taobao.com/rest/api2.do?api=mtop.eticket.wirelessConsume&v=1.0", 
		"http://api.waptest.taobao.com/rest/api3.do?api=mtop.eticket.wirelessConsume&v=1.0"
	);
